# Notes
# create_blog_post() method doesn't continue in making POST request whenever it gets to newBlogPost.  It hangs.
...
# Mehods using linked list data structure
...
def get_all_users_descending():
    ...
    return jsonify(all_users_ll.toList(), 200)
...
def get_one_user(user_id):
    ...
    user = all_users_ll.getUserById(user_id)
...
def create_blog_post(user_id):
    ...
    ht.addData("title", data["title"])
    ht.addData("body", data["body"])
    ht.addData("date", now)
    ht.addData("user_id", user_id)

    print("Start making new blogpost")
